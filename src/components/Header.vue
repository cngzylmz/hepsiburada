  ...
  <div class="home-header-container">
    <div class="top-links">
      <ul>
        ...
        <li><a href="">Yurt Dışından</a></li>
        <li><a href="">Bugün Teslimat</a></li>
        <li><a href="">Kampanyalar</a></li>
        <li><a style="color: #ed433e" href="">Girişimci Kadınlar</a></li>
    ...
    <div class="home-header-bottom">
      <div class="logo-container">
        <div class="logo">
          <svg width="200" height="32" viewBox="0 0 180 28" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <div class="header-search">
        <div class="search-container">
          ...
          <div class="search-input-container">
            <input class="search-input" type="text" placeholder="Ürün, kategori veya marka ara">
          </div>
        </div>
      </div>
      ...
      <div class="header-location">
        <div class="header-location-text">
          ...
          <div style="padding-left: 10px">
            <div>Konum</div>
            <div class="header-location-selector">
              <div>Konum seç</div>
              <div class="header-location-icon-arrow">
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="account-container">
        <div class="my-account">
          <span>
            <span class="my-account-button-text-log-in">Giriş Yap</span>
            <span class="my-account-button-text-register">veya üye ol</span>
          </span>
        </div>
        <a class="basket">
          <i class="basket-item-count">0</i>
          <span>Sepetim</span>

        </a>
      </div>
    </div>
    <div class="colorful-band">
      <div class="band-one"></div>
      <div class="band-two"></div>
      <div class="band-three"></div>
      <div class="band-four"></div>
      <div class="band-five"></div>
      <div class="band-six"></div>
    </div>

    <div class="navigation">
      <div class="navigation-container">
        <ul class="navigation-list">
          <li class="menu-items"><span class="menu-text">Elektronik</span></li>
          <li class="menu-items"><span class="menu-text">Moda</span></li>
          <li class="menu-items"><span class="menu-text">Ev, Yaşam, Kırtasiye, Ofis</span></li>
          <li class="menu-items"><span class="menu-text">Oto, Bahçe, Yapı Market</span></li>
          <li class="menu-items"><span class="menu-text">Anne, Bebek, Oyuncak</span></li>
          <li class="menu-items"><span class="menu-text">Spor, Outdoor</span></li>
          <li class="menu-items"><span class="menu-text">Kozmetik, Kişisel Bakım</span></li>
          <li class="menu-items"><span class="menu-text">Süpermarket, Pet Shop</span></li>
          <li class="menu-items"><span class="menu-text">Kitap, Müzik, Film, Hobi</span></li>
        </ul>
      </div>
    </div>
...
<style src="../style/header-home.scss" lang="scss" scoped></style>

<style src="../style/navigation-desktop.scss" lang="scss" scoped></style>